      ...
      <div className="mx-auto max-w-[1600px] px-6 py-24 lg:px-10 lg:py-40">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-8">
            <Reveal delay={0.15}>
              <h2 className="font-display text-[clamp(1.5rem,3vw,2.75rem)] font-medium leading-[1.15] tracking-tight text-ink-900">
                {company.about}
              </h2>
            </Reveal>
            <Reveal delay={0.25}>
            ...
            {/* Values — editorial list, not cards */}
            <div className="mt-16">
              <Reveal delay={0.4}>
                <p className="font-mono text-[11px] tracking-wide2 uppercase text-ink-400">
                  Our Values
              ...
              <div className="mt-6 border-t border-line">
                {company.values.map((value, i) => (
                  <Reveal key={i} delay={0.45 + i * 0.05}>
                    <div className="group flex items-start gap-4 border-b border-line py-6 transition-all duration-300 hover:pl-4 lg:gap-8">
                      <span className="mt-1 font-mono text-xs text-ink-300">
                        0{i + 1}
                      </span>
                      <div className="flex flex-1 flex-col gap-1 lg:flex-row lg:items-baseline lg:gap-8">
                        <h3 className="font-display text-lg font-medium tracking-tight text-ink-900 lg:w-48 lg:shrink-0">
                          {value.title}
                        </h3>
            ...
            <div className="mt-16">
              ...
              <div className="mt-6 flex flex-col gap-0 border-t border-line">

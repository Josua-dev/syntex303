      ...
      <div className="mx-auto max-w-[1600px] px-6 py-24 lg:px-10 lg:py-32">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
          <div className="lg:col-span-4">
            ...
            <Reveal delay={0.1}>
              <h2 className="mt-6 font-display text-[clamp(1.75rem,3vw,2.5rem)] font-medium leading-[1.05] tracking-ultra-tight text-ink-900">
                Built on evidence,
                <br />
                <span className="text-ink-400">not promises.</span>
              </h2>
            </Reveal>
          </div>
            ...
            <div className="grid grid-cols-2 gap-px bg-line lg:grid-cols-4">
              {stats.map((stat, i) => (
                <Reveal key={i} delay={i * 0.1}>
                  <div className="flex flex-col gap-4 bg-paper p-8 lg:p-10">
                    <span className="font-display text-4xl font-medium tracking-ultra-tight text-ink-900 lg:text-5xl">
                      {stat.value}
                    </span>

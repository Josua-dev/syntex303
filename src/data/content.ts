export const company = {
  ...
  legalName: 'Syntex Technologies (Pty) Ltd',
  tagline: 'Synergy to Excel',
  incorporated: '2008',
  location: 'Windhoek, Namibia',
  description:
    'Namibian ICT systems integrator providing security, enterprise and utility systems.',
  about:
  ...
  values: [
    ...
    },
    {
      ...
      subtitle: 'In our commitment',
      description:
        'We take responsibility for our actions and deliver on our commitments. We hold ourselves accountable for our work and strive to exceed expectations.',
    },
    {
      title: 'Consistency',
      subtitle: 'In our approach',
      description:
        'We strive for consistency in our work, ensuring that our solutions and services meet the highest standards and deliver reliable results.',
    },
    {
      title: 'Integrity',
    ...
    {
      title: 'Collaboration',
      subtitle: 'In our work',
      description:
        'We value collaboration and teamwork, encouraging open communication, knowledge sharing, and mutual respect. Our focus is on working closely with clients, partners, and group members to achieve shared goals.',
    },
    {
  ...
  contact: {
    salesEmail: 'sales@syntexnam.com',
    supportEmail: 'support@syntexnam.com',
...
export const solutions = [
  ...
  },
  {
    ...
    description:
      'ERP, HR, payroll and business process platforms that unify operations into a single, coherent system of record.',
  ...
  {
    number: '07',
    title: 'Data Centre & Compute',
    description:
      'Data centre design, deployment and management — from rack-level infrastructure to virtualisation and backup.',
...
export const processSteps = [
  ...
  },
  {
    number: '02',
    title: 'Design',
    description: 'Architect the complete solution.',
  },
  {
    number: '03',
    title: 'Integrate',
  ...
  },
  {
    number: '04',
    title: 'Deploy',
    description: 'Implement and commission the solution.',
  },
  {
    number: '05',
    title: 'Support',
    description: 'Maintain, monitor and evolve the system.',
  },
];

export const partnerLogos = [
  { name: 'VMware', src: '/partners/VMware.png', url: 'https://www.vmware.com' },
  { name: 'Sophos', src: '/partners/Sophos.png', url: 'https://www.sophos.com' },
  { name: 'HP', src: '/partners/HP.png', url: 'https://www.hp.com' },
  { name: 'Cisco', src: '/partners/Cisco.png', url: 'https://www.cisco.com' },
  { name: 'Oracle', src: '/partners/Oracle_partner.png', url: 'https://www.oracle.com' },
  { name: 'ManageEngine', src: '/partners/ManageEngine.png', url: 'https://www.manageengine.com' },
  { name: 'Dell', src: '/partners/Dell.png', url: 'https://www.dell.com' },
  { name: 'Amplify', src: '/partners/Amplify.png', url: 'https://amplify.com' },
  { name: 'HPE', src: '/partners/HPE.png', url: 'https://www.hpe.com' },
...
export const projects = [
  {
    number: '01',
    name: 'National Border Control System',
  ...
  {
    number: '02',
    name: 'Enterprise Resource Planning Deployment',
  ...
  {
    number: '03',
    name: 'Utility Billing & Management Platform',
  ...
  {
    number: '04',
    name: 'Data Centre & Cybersecurity Infrastructure',
    sector: 'Infrastructure — Security',
    location: 'Windhoek, Namibia',
    systems: ['Data Centre Design', 'Cybersecurity', 'Network Security', 'Managed Services'],
    image: 'https://images.pexels.com/photos/37730212/pexels-photo-37730212.jpeg?auto=compress&cs=tinysrgb&w=1600',
    span: 'lg:col-span-7',
  },
];
...
export const navItems = [
  ...
  { label: 'Services', href: '#integration' },
